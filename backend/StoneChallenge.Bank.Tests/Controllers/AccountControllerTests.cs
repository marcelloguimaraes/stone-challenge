...
namespace StoneChallenge.Bank.Tests
{
    public class AccountControllerTests
    {
        ...
        //    var mockService = new Mock<IAccountAppService>();
        //    var controller = new AccountController(mockService.Object);
        //    controller.ModelState.AddModelError("AccountViewModelInvalid", "Informe um modelo válido");

        //    //Act
        //    var result = await controller.Create(accountViewModel: null);
        ...
        //[Fact]
        //public async Task Create_Given_InvalidCustomer_Then_ReturnNotFound()
        //{
        //    // Arrange
        //    var mockService = new Mock<ICustomerAppService>();

        //    var invalidAccountViewModel = new AccountViewModel()
        //    {
        //        AccountNumber = 0,
        //        Agency = 0,
        ...
        //    mockService.Setup(service => service.GetByIdAsync(It.IsAny<string>())).ReturnsAsync((CustomerViewModel)null);

        //    var controller = new AccountController(customerAppService: mockService.Object);

        //    // Act
        //    var result = await controller.Create(accountViewModel: invalidAccountViewModel);
